...
| B01 | 18.92s | `TempScores` | Three score tiles; the two conditions; "these sum to 6" struck through | course input `[1,2,3]` | Scores rank outcomes; they are not chances |
...
| B05 | 24.60s | `TempRatio` | The ratio law in a glass panel; 7.389 / 2.718 / 1.649; "creativity" struck and replaced | `ratio_top_two` | **Why** it happens — the exponent is rescaled |
...
**Total measured narration: 158.96s (2:39).** Assembled runtime is slightly longer
